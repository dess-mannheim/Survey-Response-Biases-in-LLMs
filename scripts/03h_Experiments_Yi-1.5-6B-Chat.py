...
pipe = pipeline("text-generation", model="01-ai/Yi-1.5-6B-Chat", device=0)
...
model_response["model_name"] = "Yi-1.5-6B-Chat"
...
model_response.to_csv(f"../assets/final_interviews/{current_date}_Yi-1.5-6B-Chat_selected_interviews.csv", encoding="utf-8", sep=";")